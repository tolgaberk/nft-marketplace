	...
	<div class="base-card">
		...
		>
			<img
				...
				:src="assetUrl"
				:alt="assetTitle"
				class="base-card__asset--image"
			/>
		</div>
		<div class="base-card__content my-5 mx-4">
			<div
				class="base-card__content--profile flex justify-between items-center"
			>
				<div class="flex items-center">
					<a href="" class="inline">
						<img
							class="inline rounded-full h-10 w-10"
							:src="sellerAvatarUrl"
							:alt="sellerName"
						/>
					</a>
					<div class="ml-3">
						...
						<span
							class="block base-card__content--quantity font-medium text-xs"
						>
...
export default defineComponent({
	...
	props: {
		assetUrl: {
			type: String,
			default:
				'https://images.unsplash.com/photo-1635536816492-9a6fb49354d3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1278&q=80',
		},
		assetType: {
			type: String,
			default: 'image',
		...
		sellerAvatarUrl: {
			type: String,
			default:
				'https://images.unsplash.com/photo-1635547476327-1d2348998473?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1528&q=80',
		},
		sellerName: {
			type: String,
			default: 'John Doe',
		...
		assetDescription: {
			type: String,
			default:
				'My skills include product design, interactive design, aesthetic art direction, prototyping, mobile design, branding, front-end development and team leadership. ',
		},
		assetTags: {
			type: Array,
			default() {
